...
class DialogAdaptorStudent extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tvTitle.setText("Название : "+alCustom.get(position).getTitles());
        tvSubject.setText("Тип : "+alCustom.get(position).getSubjects());
        tvDuedate.setText("Due Date : "+alCustom.get(position).getDuedates());
        tvDescription.setText("Описание : "+alCustom.get(position).getDescripts());
